...
class TrackService {
  ...
  Future<Map<String, dynamic>> fetchDriverUserLocation(int orderId) async {
    try {
      http.Response response = await apiService.get('driverTracking/fetch-driver-tracking-and-customer-location/$orderId');
